...
for ll = 1:tNN
    ...
    TE(ll) = PE(ll)+KE(ll);
    DipoleExpectation(ll) = sum(sum(sum(Awave1.*conj(Awave2))));
...
save('D:\Chelsea_Data\TDSE_Output\DataForTheoryControlPaper\NoLightLong.mat', '-v7.3')
