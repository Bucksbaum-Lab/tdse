Delay = linspace(15,37.5,2*(37.5-15+1)-1);
DD = length(Delay);

for TT = 1:DD

    clearvars -except Delay TT DD
    close all
    clc
    disp('Coming up with time estimate...')
    disp(['Delay ' num2str(Delay(TT))])
    ...
    save(['D:\Chelsea_Data\TDSE_Output\DataForTheoryControlPaper\Pulsed_Delay' num2str(Delay(TT)) '.mat'], '-v7.3')
