...
for TT = 1:DD
    ...
    for ll = 1:tNN
        ...
        if Phase(TT) == 0
            if (((ll-1)*dt) >= pulsedelay) && (((ll-1)*dt) <= (pulsedelay + pulselength))     
    ...
    save(['D:\Chelsea_Data\TDSE_Output\DataForTheoryControlPaper\Pulsed_1eV_2_Phase' num2str(Phase(TT)) '.mat'], '-v7.3')
