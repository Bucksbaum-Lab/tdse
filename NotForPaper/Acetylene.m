...
%% Hamiltonians
CHPi = [CHPi*0.529177249;19;19.2;19.4;19.6;19.8;20];
CHS = [CHS*0.529177249;19;19.2;19.4;19.6;19.8;20];
[c1,a1,b1] = unique(CHPi);
PiNew = smooth(CHPi,[threePiu;31;31;31;31;31;31],30);
W22 = spline(CHPi(a1), PiNew(a1), XX)+kappay2*YY.^2;
[c1,a1,b1] = unique(CHS);
threeSigmaNew = smooth(CHS,[threeSigmagm;32.2;32.2;32.2;32.2;32.2;32.2],30);
W11 = spline(CHS(a1), threeSigmaNew(a1), XX)+kappay1*YY.^2;
W12 = lambda*YY;
