...
for TT = 1:length(Phase)

clearvars -except Phase TT DD
close all
clc
...
hbar = 0.658;
lighteV = 1; %eV
mu = .05*(XX<3).*(YY<3).*(ZZ<3); %eV
xposition = -1.25; %Angstrom
carrierphase = Phase(TT); 
pulsedelay = 18; %fs
pulselength = 5;
Woffset = 5;
XX01 = -1.0557;
...
Dipole11 = mu*(AdiabaticToDiabatic12.*DiabaticToAdiabatic11 + AdiabaticToDiabatic11.*DiabaticToAdiabatic21);
Dipole12 = mu*(AdiabaticToDiabatic12.*DiabaticToAdiabatic12 + AdiabaticToDiabatic11.*DiabaticToAdiabatic22);
Dipole21 = mu*(AdiabaticToDiabatic22.*DiabaticToAdiabatic11 + AdiabaticToDiabatic21.*DiabaticToAdiabatic21);
Dipole22 = mu*(AdiabaticToDiabatic22.*DiabaticToAdiabatic12 + AdiabaticToDiabatic21.*DiabaticToAdiabatic22);
...
save(['C:\Chelsea\TDSE_Output\BigFix\InterferenceFindL0.1_Phase1.mat'], '-v7.3')
%save(['C:\Chelsea\TDSE_Output\BigFix\Interference_EV1_Pos-1.25_Mu0.05_PhaseDelay' num2str(Phase(TT)) '.mat'], '-v7.3')
