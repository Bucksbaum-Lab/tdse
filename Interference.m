%Delay = linspace(13,30,2*(30-13+1)-1);
%DD = length(Phase);
Delay = 19;
...
%save(['C:\Chelsea\TDSE_Output\BigFix\Interference10LNoLightL0.1.mat'], '-v7.3')
save(['C:\Chelsea\TDSE_Output\BigFix\Interference1eVSinSq5fs3LDelay' num2str(Delay(TT)) 'fs.mat'], '-v7.3')
